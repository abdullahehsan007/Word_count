...
function Counter() {
     return (
          <div className='flex flex-col items-center justify-center'>
               <textarea id="textInput" rows={4} cols={30} className='resize-y max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl border-x-8 border-y-2 border-blue-950 bg-slate-100 rounded-3xl text-3xl text-blue-500 font-semibold flex text-center outline-none mt-12 pt-24 mx-6 placeholder-slate-300 placeholder:font-medium' placeholder='Enter Your Text Here'></textarea>
